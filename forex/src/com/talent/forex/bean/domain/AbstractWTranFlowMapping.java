...
/**
 * AbstractWTranFlowMapping entity provides the base persistence definition of the WTranFlowMapping entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractWTranFlowMapping  implements java.io.Serializable {
    ...
    /** default constructor */
    public AbstractWTranFlowMapping() {
    }

	/** minimal constructor */
    public AbstractWTranFlowMapping(String userNum) {
        this.userNum = userNum;
    }
    
    /** full constructor */
    public AbstractWTranFlowMapping(String userNum, String oneClickQty, String oneClickAmt, String stopLossQty, String stopLossAmt, String takeProfitQty, String takeProfitAmt, String ocoQty, String ocoAmt, String marketBreakoutQty, String marketBreakoutAmt, String otcSpotQty, String otcSpotAmt, String otcForwartQty, String otcForwartAmt, String otcSwapQty, String otcSwapAmt, Double amount, Integer count) {
        this.userNum = userNum;
