...
public class SpotTradeModel {
	...
	private String direction;//交易的方向（Sell或者Buy）
	
	private String tranNo1;//交易编号1
	
	private String tranNo2;//交易编号2
	
	private String tranNo3;//交易编号3
	
	private String tranNo4;//交易编号4
	
	private String tranNo5;//交易编号5
