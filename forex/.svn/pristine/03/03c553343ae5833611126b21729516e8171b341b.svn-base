...
/**
 * AbstractTakeProfitInfo entity provides the base persistence definition of the
 * TakeProfitInfo entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractTakeProfitInfo implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractTakeProfitInfo() {
	}

	/** minimal constructor */
	public AbstractTakeProfitInfo(String tranType, String tranNo,
			String userNum, String weCcy, String anaCcy, String amount,
			String direction, String price, String monitorPrice,
	...
	public AbstractTakeProfitInfo(String tranType, String tranNo,
			String userNum, String weCcy, String anaCcy, String amount,
			String direction, String date, String time, String price,
