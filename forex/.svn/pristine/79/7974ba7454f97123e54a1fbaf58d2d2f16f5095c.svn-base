...
public class ExamForward {
    ...
    public int getExamForwardNo() {
        return examForwardNo;
    }

    public void setExamForwardNo(int examForwardNo) {
        this.examForwardNo = examForwardNo;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExamForward that = (ExamForward) o;

        if (examForwardNo != that.examForwardNo) return false;
        if (providerNo != that.providerNo) return false;
