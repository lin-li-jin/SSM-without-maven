...
<html>
  ...
  <body>
	  	<div id="all">
	  		<div id="top">
	    		<span style="margin-left: 10px;">admin账户综合排名:</span>
		    </div>
		    <div id="button">
		    ...
		    <div class="modules">
				<form name="form1" action="accountNumberSynthesizeSearch.action" method="post">
				    <span>一级组:</span>
				    ...
				    <span>排名方式:</span>
				    <select name="rankingType" style="margin-left: 20px;width:100px">
				    ...
				    <span>排名范围:</span>
				    <select id="rankingRange" name="rankingRange" style="margin-left: 20px;width:100px">
				    </select>&nbsp;
