...
<html>
  <head> 
	...
	<script type="text/javascript">
		$(function(){
			if ('<ww:property value="#request.tradeCard.tradeDirection"/>' == 0){//卖
			...
			document.getElementById("ccy1").innerHTML = '<ww:property value="#request.tradeCard.amount"/>';
			document.getElementById("ccy2").innerHTML = '<ww:property value="#request.tradeCard.sum"/>';
		});
	</script>
  </head>
  	...
  	<form action="">
  		<div id="container">
	    	<div class="modules2">
	    		...
	    		<label id="label1"></label><span><label id="ccy1"></label></span><br><br><br>
	    	...
	    	<div class="modules2">
	    		...
	    		<label id="label2"></label><span><label id="ccy2"></label></span><br><br><br>
	    		<label>交易时间：</label><span><ww:property value="#request.tradeCard.realDate"/> <ww:property value="#request.tradeCard.realTime"/></span><br><br><br>
