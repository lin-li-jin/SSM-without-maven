...
public class ExamStopLoss {
    ...
    public boolean equals(Object o) {
        ...
        if (examScore != null ? !examScore.equals(stopLoss.examScore) : stopLoss.examScore != null) return false;
        if (userType != null ? !userType.equals(stopLoss.userType) : stopLoss.userType != null) return false;
