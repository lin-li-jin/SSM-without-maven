...
/**
 * AbstractCodeTableId entity provides the base persistence definition of the CodeTableId entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractCodeTableId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof AbstractCodeTableId) ) return false;
