			...
			<div id="body">
				<table width="80%" style="{margin-top:100px;border:2px solid #C3BEF4;}">
					<ww:if test='#request.tipModel.processCode=="00"'>
						...
						<ww:if test='#request.endFlashName==null || #request.endFlashName==""'>
						<TR bgcolor="#F4F9FE">
						...
						<ww:else>
							<object style="border:5px solid #ccc" type="application/x-shockwave-flash" data="<ww:property value="#request.endFlashName"/>" width="675" height="500" id="dreamdu">
							<param name="movie" value="<ww:property value="#request.endFlashName"/>" />
