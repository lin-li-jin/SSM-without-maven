...
<html>
  ...
  <body>
    <div id="all">
    	<form action="forwardCashPageAdd.action" name="forwardCashForm">
    	<div id="top">
    	...
    	<div id="container">
    		<div id="wrapOne">
    			<ww:if test="#request.direction==1">
	  			...
	  			<input type="hidden" name="mfim.weCcy" value="<ww:property value='#request.weCcy'/>">
	  			<input type="hidden" name="mfim.anaCcy" value="<ww:property value='#request.anaCcy'/>">
  			</div>

  			<div class="modules1">
  				<div class="modules1left">
  					<span style="margin-right: 32px;">Value Date:</span>
  					<select name="mfim.valueDate">
  						<option value="3d" selected="selected">3 days</option>
					...
					<input id="factor" type="hidden" name="mfim.factor" value="<ww:property value='#request.factor'/>" />
  					<br><br>

  					<span>Account Amount:</span>
  					<input id="accountAmount" name="mfim.accountAmount" type="text" size="15" onkeyup="this.value=this.value.replace(/\D/g,'');beFactor(this.value);">
  					<br><br>



  					<span style="margin-right: 25px;">Deal Amount:</span>
 					<input id="dealAmount" name="mfim.dealAmount" type="text" size="15" readonly="readonly" >
  					<br><br>

  					<span>Price:</span>
 					<input id="price" name="mfim.price" type="text" size="10" readonly="readonly" value="<ww:property value='#request.price'/>" style="margin-left: 30px;">
 					<input type="button" value="Market Price" style="width: 100px;" onclick="refreshPrice()">
  				</div>
  				<div class="modules1right">
  					<!-- 买卖方向 -->
  					<input type="hidden" name="mfim.direction" value="<ww:property value='#request.direction'/>">
  					Account:<label style="font-size: 16px;"><ww:property value="#request.accnoB" /></label>
  					<input type="hidden" name="mfim.account" value="<ww:property value='#request.accnoB'/>" />
  					<div class="part">
  					<br>
  					<span>Account Balance:</span><br>
  					<span>账户余额:</span><br>
					<ww:iterator value="#request.accInfoListB">
					  <ww:property value="ccy"/>:<ww:property value="amount"/>
					  <br>
					</ww:iterator>
  					</div>
  				</div>
