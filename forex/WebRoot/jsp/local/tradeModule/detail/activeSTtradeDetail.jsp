...
<html>
  <head> 
	...
	<style type="text/css">
		...
		#wrapOne{margin: 0;padding: 0; height: 100px; width: 800px !important; width:790px;  
		margin-bottom: 3px; line-height: 100px; text-align: center; }
		
		#wrapTwo{margin: 0;padding: 0; height: 80px;width: 720px !important; width:710px;  
		margin-bottom: 3px; padding-top: 20px; padding-left: 80px; }
		
		#wrapThree{margin: 0;padding: 0; height: 100px; width: 800px !important; width:790px; 
		margin-bottom: 3px; }
...
　　				var time = <ww:property value="#request.tradeCard.realCancelTime"/>;
		...
		$(function(){
			if (<ww:property value="#request.tradeCard.tradeDirection" /> == 0){
				...
				document.getElementById("span").innerHTML = "I Sell " + '<ww:property value="#request.tradeCard.weCcy" />';
			}
			else{
				...
				document.getElementById("span").innerHTML = "I Buy " + '<ww:property value="#request.tradeCard.anaCcy" />';
			}
    ...
    <div id="top">
  	...
  	<div id="container">
  		<div id="wrapOne">
  			...
  			<!-- <label>Price:</label><label>9.6598</label> -->
  		</div>
  		<div id="wrapTwo">
  			<span style="font-weight: bolder; font-size: 18px;" id="span"></span>&nbsp;&nbsp;&nbsp;&nbsp;
  		...
  		<div id="wrapThree">
  			<div class="part">
  				...
  				<input type="radio" name="timeStart" id="rOne" onclick="return checkOne();" style="margin-left: 30px;" disabled="disabled">ACTIVATION<br>
  				...
  				<input id="d1" style="display: none;" type="text" dataType="date" size="10" disabled="disabled" value="<ww:property value='#request.tradeCard.realActiveTime'/>"/>
  			</div>
  			<div class="part">
  				<span style="font-weight: bolder; font-size: 18px;">GOOD TILL</span><br>
  				<input type="radio" name="timeEnd" id="rThree" onclick="return checkTwo();" style="margin-left: 30px;" disabled="disabled">CANCELLED<br>
  				...
  				<input id="d2" style="display: none;" type="text" dataType="date" size="10" disabled="disabled" value="<ww:property value='#request.tradeCard.realCancelTime'/>"/>
  			</div>
  		</div>
  	</div>
  	<div id="top">
