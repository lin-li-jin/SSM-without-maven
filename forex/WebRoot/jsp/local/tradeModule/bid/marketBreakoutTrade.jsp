...
<html>
  <head> 
	...
	<style type="text/css">
		...
		#wrapTwo{margin: 0;padding: 0; height: 120px; width: 800px !important; width:790px;  margin-bottom: 3px; padding-top: 20px; padding-left: 80px;}
  ...
  <body>
  <form action="" method="post" name="marketBreakoutForm">
    <div id="top">
  	...
  	<div id="container">
  		...
  		<div id="wrapTwo">
  			...
  			Amount:<input type="text" size="10" name="marketModel.tAmount" id="sAmount" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">&nbsp;&nbsp;
  			Price:<input type="text" size="10" name="marketModel.tPrice" id="sPrice">&nbsp;&nbsp;
  			<span>Stop Loss</span>
  			<br><br>
  			<span style="font-weight: bolder; font-size: 18px;" id="tradeDirSpan2"></span><ww:property value="#request.ccy1"/>
  			Amount:<input type="text" size="10" name="marketModel.sAmount" id="SAmount" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">&nbsp;&nbsp;
  			Price:<input type="text" size="10" name="marketModel.sPrice" id="SPrice">&nbsp;&nbsp;
  			<span>Stop Loss</span>
  			<br><br>
  			Monitor Type:
  			<select name="marketModel.monitorPrice">
  				<option value="B/B">MONITOR BID/BID PRICE</option>
  				<option value="A/B">MONITOR ASK/BID PRICE</option>
  				<option value="A/A">MONITOR ASK/ASK PRICE</option>
  				<option value="B/A">MONITOR BID/ASK PRICE</option>
  			</select>
  		</div>
  		<div id="wrapThree">
  			<div class="part">
  				...
  				<input id="d1" style="display: none;" type="text" dataType="date" size="10" name="marketModel.activeTime" />
  			</div>
  			<div class="part">
  				...
  				<input id="d2" style="display: none;" type="text" dataType="date" size="10" name="marketModel.cancelTime" />
  			</div>
  		</div>
  	</div>
  	<div id="top">
  		<input type="button" value="ACTIVE" class="button2" style="margin-right: 100px;" onclick="marketBreakoutTradeToAction();">
  		<input type="button" value="DELETE" class="button2" onclick="selectBackAction()">
  		<input type="hidden" id="tradeDirection" name="marketModel.tradeDirection" value="<ww:property value='#request.tradeDirection'/>">
  		<input type="hidden" name="marketModel.ccy1" value="<ww:property value='#request.ccy1'/>">
  		<input type="hidden" name="marketModel.ccy2" value="<ww:property value='#request.ccy2'/>" id="ccyHidden">
  	</div>
  </form>
