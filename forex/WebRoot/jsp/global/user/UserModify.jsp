...
<body><%--
				...
				<div class="curved">
					<b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
						<div class="boxcontent">
							<font  style="{size:3}" color="#000000">用户修改</font>
						</div>
				...
				<div>
					...
					<span class="left">
						<select name="userInfo.pwdValidTime">
							<option value="7" <ww:if test="#session.userInfoModel.pwdValidTime == 7">selected</ww:if>>一周</option>
							<option value="30" <ww:if test="#session.userInfoModel.pwdValidTime == 30">selected</ww:if>>一个月</option>
							<option value="365" <ww:if test="#session.userInfoModel.pwdValidTime == 365">selected</ww:if>>一年</option>
							<option value="0" <ww:if test="#session.userInfoModel.pwdValidTime == 0">selected</ww:if>>永不过期</option>
						</select><font color="red">*</font>
					</span>				
				</div>
				<div>
	...
	<br />
	<center>
		<input type="button" class="button" name="submitBt" value="提 交" onclick="userModifySubmit('userModifyForm')">
