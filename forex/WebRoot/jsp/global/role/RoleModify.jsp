...
<div id="body">
	...
	<br />	
	<center>
			<input class="button" class="button" type="button" name="submitBt" value="提 交" onclick="roleSubmit('roleModifyForm')">
			<input class="button" class="button" type="button" name="backBt" value="返 回" onclick="window.location='rolesListQuery.action'">
	</center>
	<br />
	<br />				
	<form name="roleModifyForm" method="post" action="roleModify.action">
